...
const HeaderV2 = () => {
  ...
  return (
    <>
      <header>
        <nav
          className={`navbar mobile-sidenav navbar-default validnavs nav-full-width white bg-dark navbar-fixed ${
              ...
              <div className="collapse navbar-collapse" id="navbar-menu">
                <div className="left-info">
                  <p>
                    ...
                    <a href="mailto:support@avrix.com">support@avrix.com</a>
                  </p>
                </div>
            ...
            <div className="attr-right">
              ...
              <div className="col-lg-2">
                <div className={`side text-light ${isInfoOpen ? "on" : ""}`}>
                  <Link href="#" className="close-side" onClick={closeInfoBar}>
